...
def fiche_export_excel(request):
    ...
    headers = [
        ...
        "Grade responsable région",
        "Abréviation grade région",
        "Nom responsable région",
        "Prénoms responsable région",
        "Identité responsable région",
        "Province",
        "Titre responsable province",
        "Grade responsable province",
        "Abréviation grade province",
        "Nom responsable province",
        "Prénoms responsable province",
        "Identité responsable province",
        "District",
        "Titre responsable district",
        "Grade responsable district",
        "Abréviation grade district",
        "Nom responsable district",
        "Prénoms responsable district",
        "Identité responsable district",
        "Zone",
        "Titre responsable zone",
        "Grade responsable zone",
        "Abréviation grade zone",
        "Nom responsable zone",
        "Prénoms responsable zone",
        "Identité responsable zone",
        "Paroisse",
    ]
    ws.append(headers)
    ...
    for fiche in fiches:
        ...
        ws.append(
            [
                ...
                r["region"]["titre"],
                r["region"]["grade"],
                r["region"]["grade_abreviation"],
                r["region"]["nom"] or r["region"]["nom_legacy"],
                r["region"]["prenoms"],
                r["region"]["identite"],
                fiche.province.nom,
                r["province"]["titre"],
                r["province"]["grade"],
                r["province"]["grade_abreviation"],
                r["province"]["nom"] or r["province"]["nom_legacy"],
                r["province"]["prenoms"],
                r["province"]["identite"],
                fiche.district.nom,
                r["district"]["titre"],
                r["district"]["grade"],
                r["district"]["grade_abreviation"],
                r["district"]["nom"] or r["district"]["nom_legacy"],
                r["district"]["prenoms"],
                r["district"]["identite"],
                fiche.zone.nom,
                r["zone"]["titre"],
                r["zone"]["grade"],
                r["zone"]["grade_abreviation"],
                r["zone"]["nom"] or r["zone"]["nom_legacy"],
                r["zone"]["prenoms"],
                r["zone"]["identite"],
