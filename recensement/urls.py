...
urlpatterns = [
    ...
    path("administration/organisations/<int:pk>/modifier/", employes_views.organisation_update, name="organisation_update"),
    ...
    # Administration — Registre des badges administratifs
    path("administration/badges/", badges_views.badge_list, name="badge_list"),
    path("administration/employes/<int:employe_pk>/badges/nouveau/", badges_views.badge_create_for_employe, name="badge_create_for_employe"),
    path("administration/badges/<int:pk>/", badges_views.badge_detail, name="badge_detail"),
    path("administration/badges/<int:pk>/modifier/", badges_views.badge_update, name="badge_update"),
    path("administration/badges/<int:pk>/action/<str:action>/", badges_views.badge_action, name="badge_action"),
    path("administration/badges/<int:pk>/qrcode.png", badges_views.badge_qrcode, name="badge_qrcode"),
    path("badges/verifier/<slug:token_public>/", badges_views.badge_verifier, name="badge_verifier"),

    # Administration — Rôles globaux et permissions modulaires
    path("administration/roles-permissions/", roles_permissions_views.role_plateforme_list, name="role_plateforme_list"),
    path("administration/roles-permissions/nouveau/", roles_permissions_views.role_plateforme_create, name="role_plateforme_create"),
    path("administration/roles-permissions/<int:pk>/", roles_permissions_views.role_plateforme_detail, name="role_plateforme_detail"),
    path("administration/roles-permissions/<int:pk>/modifier/", roles_permissions_views.role_plateforme_update, name="role_plateforme_update"),
    path("administration/roles-permissions/<int:pk>/activer-desactiver/", roles_permissions_views.role_plateforme_toggle, name="role_plateforme_toggle"),
    ...
    path("administration/utilisateurs/nouveau/", access_views.utilisateur_systeme_create, name="utilisateur_systeme_create"),
    path("administration/utilisateurs/<int:pk>/cree/", access_views.utilisateur_systeme_created, name="utilisateur_systeme_created"),
