...
# Les sérialiseurs liés aux comptes utilisateurs vivent maintenant dans
# `accounts` (Phase R3 de la refactorisation) — ré-exportés ici pour ne
# casser aucun import existant (`from .serializers import
# UtilisateurCourantSerializer` continue de fonctionner dans api/views.py).
from accounts.serializers import (  # noqa: F401  (ré-export, compatibilité)
